...
<?php if ($_SERVER['REQUEST_METHOD']=="POST") { ?>
    ...
    <?php require("../../d_con/database_connection.php"); ?>
    ...
    <?php while ($des=$select->fetch_assoc()) { ?>  


    <form name="prx-form" id="prx-form" action="admin_update.php" method="post">
    <table>
    ...
    <tr>
        ...
        <td>AMOUNT PAID:</td> 
        <td>
            <input type="number" size="25" name="ap" required onkeyup="bold()" value="<?php echo $des['AMOUNT_PAID']; ?>">
        </td> 
